...
import { formatter, getCookie, parseRequestUrl } from "../utils";

const Header = {
  async render() {
    const { data: categories } = await CategoryApi.getAll();
    let listProduct = JSON.parse(localStorage.getItem("itemsArray"));
    ...
    if (listProduct != null) {
        ...
        <div class="navbar-cart-product"> 
                  ...
                  <img class="img-fluid navbar-cart-product-image pl-3" src="${
                    ...
                    <div class="w-100">
                      ...
                      <div class="pl-5"> <a class="navbar-cart-product-link" href="/#/products/${
                        product.id
                      }">${product.name}</a>
                      <a href="/#/products/${
                        product.id
            ...
            product.quantity
                      ...
                      <a href="/#/products/${
                        product.id
                      }"> <strong class="d-block text-sm">${formatter.format(
      ...
      output = `<h4 class="text-center">Chưa có sản phẩm nào</h4>`;
    }
        ...
        <div class="row d-flex align-items-center">
          <div class="col-sm-7 d-none d-sm-block">
            <ul class="list-inline mb-0">
              ...
              <li class="list-inline-item px-3 border-left d-none d-lg-inline-block">Never freeship hehehe</li>
            </ul>
          </div>
          <div class="col-sm-5 d-flex justify-content-end">
            <!-- Language Dropdown-->
            <div class="dropdown border-right px-3"><a class="dropdown-toggle topbar-link" id="langsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="topbar-flag" src="https://d19m59y37dris4.cloudfront.net/sell/1-4/img/united-kingdom.svg" alt="english">English</a>
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="langsDropdown"><a class="dropdown-item text-sm" href="#"><img class="topbar-flag" src="https://d19m59y37dris4.cloudfront.net/sell/1-4/img/germany.svg" alt="german">German</a><a class="dropdown-item text-sm" href="#"> <img class="topbar-flag" src="https://d19m59y37dris4.cloudfront.net/sell/1-4/img/france.svg" alt="french">French</a></div>
            </div>
            <!-- Currency Dropdown-->
            <div class="dropdown pl-3 ml-0"><a class="dropdown-toggle topbar-link" id="currencyDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">USD</a>
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="currencyDropdown"><a class="dropdown-item text-sm" href="#">EUR</a><a class="dropdown-item text-sm" href="#"> GBP</a></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-sticky navbar-airy navbar-light bg-white bg-fixed-white">
      <div class="container-fluid">  
        <!-- Navbar Header  --><a class="navbar-brand" href="/#/"><svg class="navbar-brand-svg" viewBox="0 0 65 16" width="85" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path class="text-primary" d="M62.0254 15.4219H64.418V18H62.0254V15.4219Z" transform="translate(0 -3)" fill="#9A6EE2"/>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <li class="nav-item"><a class="nav-link ${
            resource == "about" ? "active" : ""
          }" href="/#/about">About</a>
          <li class="nav-item"><a class="nav-link ${
            resource == "products" ? "active" : ""
          ...
          <div class="d-flex align-items-center justify-content-between justify-content-lg-end mt-1 mb-2 my-lg-0">
            ...
            <div class="nav-item"><a class="navbar-icon-link" href="${
              getCookie("id") == undefined ? "/#/account" : "/#/user"
            }">
                <svg class="svg-icon">
    ...
    <circle data-name="layer1" cx="32" cy="32" r="30" fill="none" stroke="#202020" stroke-miterlimit="10" stroke-linejoin="round" stroke-linecap="round" style="stroke:var(--layer1, #202020)"></circle>
            ...
            <!-- Cart Dropdown-->
            <div class="nav-item dropdown" id="cartDrop"><a class="navbar-icon-link d-lg-none" > 
            <svg class="svg-icon">
    ...
    <circle data-name="layer1" cx="49" cy="54" r="4" fill="none" stroke="#202020" stroke-miterlimit="10" stroke-linejoin="round" stroke-linecap="round" style="stroke:var(--layer1, #202020)"></circle>
          ...
          <div id="showCart" class="d-none d-lg-block"><a class="navbar-icon-link dropdown-toggle" id="cartdetails"  data-target="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <svg class="svg-icon">
                <use xlink:href="#cart-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="cart-1">
    <title>Cart</title>
    ...
    <circle data-name="layer1" cx="49" cy="54" r="4" fill="none" stroke="#202020" stroke-miterlimit="10" stroke-linejoin="round" stroke-linecap="round" style="stroke:var(--layer1, #202020)"></circle>
            ...
            <div id="showCart1" class="dropdown-menu dropdown-menu-right p-4" aria-labelledby="cartdetails">
              ...
              <!-- total price-->
              <!-- buttons-->
              <div class="d-flex justify-content-between"><a class="btn btn-link text-dark mr-3" href="/#/cart">View Cart <i class="fa-arrow-right fa"></i></a><a class="btn btn-outline-dark" href="/#/checkout">Checkout</a></div>
            </div>
          </div>
        </div>
          </div>
    ...
    <div class="search-area d-flex align-items-center justify-content-center">
      <div class="close-btn">
        <svg class="svg-icon svg-icon-light w-3rem h-3rem">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="close-1">
    <title>Close</title>
    <desc>A line styled icon from Orion Icon Library.</desc>
