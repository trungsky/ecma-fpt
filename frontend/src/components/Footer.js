          ...
          <div class="row">
            <div class="col-lg-4 service-column">
              <svg class="svg-icon service-icon">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="delivery-time-1">
    ...
    <path data-name="layer1" fill="none" stroke="#202020" stroke-miterlimit="10" d="M14 12v8h6" stroke-linejoin="round" stroke-linecap="round" style="stroke:var(--layer1, #202020)"></path>
            ...
            <div class="col-lg-4 service-column">
              <svg class="svg-icon service-icon">
                ...
                <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" id="money-1">
    <title>Money</title>
    <desc>A line styled icon from Orion Icon Library.</desc>
    ...
    <path stroke-miterlimit="10" stroke="#202020" fill="none" d="M46.93 37a4.993 4.993 0 0 0-1.535-2.835" data-name="layer1" stroke-linejoin="round" stroke-linecap="round" style="stroke:var(--layer2, #202020)"></path>
            ...
            <div class="col-lg-4 service-column">
              <svg class="svg-icon service-icon">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="customer-support-1">
          ...
          <div class="row">
            <div class="col-lg-4 mb-5 mb-lg-0">
              ...
              <ul class="list-inline">
                <li class="list-inline-item"><a class="text-muted text-hover-primary" href="https://www.facebook.com/TrungSkyFB" target="_blank" title="twitter"><i class="fab fa-twitter"></i></a></li>
                <li class="list-inline-item"><a class="text-muted text-hover-primary" href="https://www.facebook.com/TrungSkyFB" target="_blank" title="facebook"><i class="fab fa-facebook"></i></a></li>
                <li class="list-inline-item"><a class="text-muted text-hover-primary" href="https://www.facebook.com/TrungSkyFB" target="_blank" title="instagram"><i class="fab fa-instagram"></i></a></li>
              </ul>
            </div>
            <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
              <h6 class="text-uppercase text-dark mb-3">Shop</h6>
              <ul class="list-unstyled">
                <li> <a class="text-muted" href="/#/category/1">JACKETS</a></li>
                <li> <a class="text-muted" href="/#/category/2">HOODIE</a></li>
                <li> <a class="text-muted" href="/#/category/3">BOTTOMS</a></li>
              </ul>
            </div>
            <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
              <h6 class="text-uppercase text-dark mb-3">Company</h6>
              <ul class="list-unstyled">
                <li> <a class="text-muted" href="/#/account">Login                    </a></li>
                <li> <a class="text-muted" href="/#/account">Register                    </a></li>
              </ul>
            </div>
            <div class="col-lg-4">
              ...
              <form action="#" id="newsletter-form">
                <div class="input-group mb-3">
                  <input class="form-control bg-transparent border-secondary border-right-0" type="email" placeholder="Your Email Address" aria-label="Your Email Address">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-left">
              <p class="mb-md-0">&copy; 2020 TrungSky.  All rights reserved.</p>
            </div>
            <div class="col-md-6">
              <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
                <li class="list-inline-item"><img class="w-2rem" src="https://d19m59y37dris4.cloudfront.net/sell/1-4/img/visa.svg" alt="..."></li>
                <li class="list-inline-item"><img class="w-2rem" src="https://d19m59y37dris4.cloudfront.net/sell/1-4/img/mastercard.svg" alt="..."></li>
                <li class="list-inline-item"><img class="w-2rem" src="https://d19m59y37dris4.cloudfront.net/sell/1-4/img/paypal.svg" alt="..."></li>
                <li class="list-inline-item"><img class="w-2rem" src="https://d19m59y37dris4.cloudfront.net/sell/1-4/img/western-union.svg" alt="..."></li>
              </ul>
            </div>
          </div>
        </div>
